...
entry = tk.Entry(Keyboard_App, width=97)
...
def select(value, x, y):
    ...
    if value == "<-":
        ...
        entry.insert(command=enviar_voz())
    else:
...
for button in keys:
    if button != "Espacio":
        but = tk.Button(Keyboard_App, text=button, width=5, bg="#8DE493", fg="#000000", highlightthickness=4,
                        activebackground="gray65", highlightcolor='#32E385', activeforeground="#000000",
                        relief="raised", padx=12,
